...
export default function LoginEmailPassword() {
  ...
  return (
    <div className="min-h-[70vh] grid place-items-center p-6">
      <form onSubmit={onSubmit} className="w-full max-w-sm border rounded p-6 space-y-4" aria-label="Login form">
        ...
        <a className="text-sm underline" href="/auth/reset">Forgot password?</a>
      </form>
    </div>
  );
}
